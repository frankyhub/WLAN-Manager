...
Die WLAN-Daten SSID und Passwort werden im SPIFFS (Serial Peripheral Interface Flash File System) gespeichert, d.h. sie stehen auch nach einem Spannungsausfall zur Verfügung und müssen nicht erneut eingegeben werden.
